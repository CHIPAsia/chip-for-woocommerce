...
const PAYMENT_METHOD_NAME = 'chip_woocommerce_gateway_3';
    ...
    <div className="chip-bank-select">
      <div className="wc-blocks-components-select">
        <div className="wc-blocks-components-select__container">
          <label htmlFor="chip-fpx-bank-3" className="wc-blocks-components-select__label">
...
const Fpxb2b1BankList = (props) => {
  ...
  return (
    <div className="chip-bank-select">
      <div className="wc-blocks-components-select">
        <div className="wc-blocks-components-select__container">
          <label htmlFor="chip-fpx-b2b1-bank-3" className="wc-blocks-components-select__label">
            {__("Corporate Internet Banking", "chip-for-woocommerce")}
          </label>
          <select
            id="chip-fpx-b2b1-bank-3"
            className="wc-blocks-components-select__select"
            value={bankIdB2b}
...
const RazerEWalletList = (props) => {
  ...
  return (
    <div className="chip-bank-select">
      <div className="wc-blocks-components-select">
        <div className="wc-blocks-components-select__container">
          <label htmlFor="chip-razer-ewallet-3" className="wc-blocks-components-select__label">
            {__("E-Wallet", "chip-for-woocommerce")}
          </label>
          <select
            id="chip-razer-ewallet-3"
            className="wc-blocks-components-select__select"
            value={walletId}
  ...
  return (
    <div className="wc-block-components-card-form">
      <div className={`wc-block-components-text-input is-active ${cardName ? 'has-value' : ''}`}>
        ...
        />
        <label htmlFor="chip-cardholder-name-3" className="wc-block-components-text-input__label">
      ...
      <div className={`wc-block-components-text-input is-active ${cardNumber ? 'has-value' : ''}`}>
        ...
        />
        <label htmlFor="chip-card-number-3" className="wc-block-components-text-input__label">
      ...
      <div className="wc-block-components-card-form__row" style={{ display: 'flex', gap: '16px' }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div className={`wc-block-components-text-input is-active ${cardExpiry ? 'has-value' : ''}`}>
            ...
            />
            <label htmlFor="chip-card-expiry-3" className="wc-block-components-text-input__label">
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div className={`wc-block-components-text-input is-active ${cardCvc ? 'has-value' : ''}`}>
            ...
            />
            <label htmlFor="chip-card-cvc-3" className="wc-block-components-text-input__label">
...
registerPaymentMethod(chip_woocommerce_gateway_3);
