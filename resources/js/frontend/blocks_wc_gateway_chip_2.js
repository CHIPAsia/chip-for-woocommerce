...
const settings = getSetting(gateway_wc_gateway_chip_2.id + "_data", {});
...
const FpxBankList = (props) => {
  ...
  const fpx_b2c = gateway_wc_gateway_chip_2.fpx_b2c
...
const Fpxb2b1BankList = (props) => {
  ...
  const fpx_b2b1 = gateway_wc_gateway_chip_2.fpx_b2b1
