    ...
    <div className="chip-bank-select">
      <div className="wc-blocks-components-select">
        <div className="wc-blocks-components-select__container">
          <label htmlFor="chip-fpx-bank-2" className="wc-blocks-components-select__label">
...
const Fpxb2b1BankList = (props) => {
  ...
  return (
    <div className="chip-bank-select">
      <div className="wc-blocks-components-select">
        <div className="wc-blocks-components-select__container">
          <label htmlFor="chip-fpx-b2b1-bank-2" className="wc-blocks-components-select__label">
...
const RazerEWalletList = (props) => {
  ...
  return (
    <div className="chip-bank-select">
      <div className="wc-blocks-components-select">
        <div className="wc-blocks-components-select__container">
          <label htmlFor="chip-razer-ewallet-2" className="wc-blocks-components-select__label">
